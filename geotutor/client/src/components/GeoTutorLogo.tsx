...
export function GeoTutorLogo({
  ...
  // no gap: the brand reads as one word, "GeoTutor", never "Geo Tutor"
  const sizeConfig = {
    sm: { logoHeight: "h-4", fontSize: "text-lg", gap: "gap-0" },
    md: { logoHeight: "h-6", fontSize: "text-2xl", gap: "gap-0" },
    lg: { logoHeight: "h-9", fontSize: "text-3xl", gap: "gap-0" },
  };
